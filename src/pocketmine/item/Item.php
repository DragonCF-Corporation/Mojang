...
class Item{
	...
	private static function initCreativeItems(){
		...
		self::addCreativeItem(Item::get(Item::DYE, 8));
                ...
                self::addCreativeItem(Item::get(Item::MOB_HEAD, 5));
                ...
                self::addCreativeItem(Item::get(Item::POTION, 36));
                ...
                self::addCreativeItem(Item::get(Item::SPLASH_POTION, 36));
        ...
        self::addCreativeItem(Item::get(Item::ELYTRA, 0));
